...
- [x] **W0-1 — Commit the audit corpus and this plan.**
...
- [x] **W1-1 — Create the LOG and record the baseline.**
...
- [x] **W3-1 — Guild Apprentice gets its Specialty (three-way propagation).** *(rul-H1 — D4; DESIGN §1 S1)* **TDD**
...
- [x] **W3-6 — Redefine pushing scope against the pre-Technique cap.** *(cre-M3, mm-L8 — D8)*
...
- [x] **W3-8 — Give the Trouble Table a canonical home.** *(mm-M3, part 1 — D3)*
...
- [x] **W3-9 — Two Common Rulings into III.1.** *(mm-M3, part 2 — D3)*
...
- [x] **W3-10 — MM2: "Adjudicating Magic".** *(mm-M6 — D10, part 1)*
...
- [x] **W3-11 — MM coverage pointers + MM5 compression of the new section.** *(mm-M6, mm-L9 — D10, part 2)*
...
- [x] **W3-13 — II.4a gains its Facet introduction.** *(cre-M6)*
...
- [x] **W3-14 — Rule two findings as-designed.** *(cre-M7, rul-L5)*
