# B1. Beasts and Vermin

Three families of things that are not thinking about you, and one chicken.

That is the theme of this chapter, and it is worth stating plainly because it is the hardest thing to run well. Everything in here has a reason to be where it is that has nothing to do with the party. The chalk hounds are running their road. The glassbacks are raising calves. The ledgerlice are eating. None of them woke up wanting an adventure, and all of them will hurt somebody who insists.

---

## Chalk Hounds

*Dust comes up off the road ahead of you, in a line, moving at about the speed of a horse. There is no horse. As the line gets closer it stops being a line and becomes four of something running shoulder to shoulder, pale as the road itself, with two dark stones set where the eyes would go. You can hear them. It is not the sound of feet.*

Chalk hounds are what a road remembers about being travelled. They accumulate on stretches that have carried a great deal of traffic and a certain amount of violence, and they hold the shape of a running dog for as long as they are running and not one moment longer. A hound at a dead stop is a drift of pale grit with two pebbles in it, and will not get up again.

They cannot leave their road. Not will not — cannot. A pack's territory is measured in miles of surface, and the boundary is exactly where the metalled road ends. Carters know this the way they know where the fords are, and the good ones will tell you for free.

**A pack keeps to one stretch for decades.** The oldest packs run roads that no longer go anywhere, chasing carts along the ghost of a trade route through farmland that swallowed it two generations back. Farmers on those fields plough around the line without thinking about why.
...
> **What Characters Can Know — chalk hounds**
>
> **6−** — *"They only run in one line. Whatever else is true, they're following the road."*
>
> **7–9** — *"They're not alive, whatever they look like. That's road-dust holding a shape, and it's the running that holds it — nothing you're seeing has a heart in it."*
>
> **10+** — *"Stop moving and you stop being prey. They can't strike from standing, and they can't stand — the moment one of them holds still it comes apart. The problem isn't outrunning them. The problem is that everything in you is going to want to run."*
...
**Adaptation.** Any world with roads has these. Change the material — soot on a mill road, salt on a causeway, ash where something burned — and the entry survives intact. What must not change is the standing-still rule and the road boundary, because those two facts are the whole creature. A chalk hound that can chase you into a field is just a dog.

---

## Glassbacks

*The first thing is a sound like someone tapping a wineglass, a long way off, over and over. Then the treeline opens and there are twenty of them in the meadow: elk the colour of wet slate, heavy through the shoulder, and every adult carrying a rack of something clear that catches the light and throws it further than antler has any business throwing anything. One of them has stopped eating and is looking at you.*

Glassback antler is a mineral, and nobody has satisfactorily explained how an animal grows it. It rings on impact, carries light down its length, and is worth roughly its weight in worked silver at any market within a month's travel of a herd — which is why the shed antler trade exists, and why the herds are as wary as they are.

A herd is eight to twenty, with a calf for every three adults, and it moves on a seasonal circuit measured in hundreds of miles. **They shed in autumn.** A shed rack lies in the grass for anyone to take, and taking one is completely safe, completely legal in most places, and completely uninteresting to the herd. Approximately nobody does this, because approximately everybody would rather have the antler still attached to something.

Glassbacks are not dangerous. Glassbacks defending a calf are extremely dangerous, and the distance between those two states is about nine feet.
...
> **What Characters Can Know — glassbacks**
>
> **6−** — *"Herd animals, and they've seen us. They're not running, which means they don't think they need to."*
>
> **7–9** — *"Those antlers are the trade — a shed rack is worth a season's wages and the herd doesn't care who takes one. It's the calves they care about. Watch where the calves are and stand somewhere else."*
>
> **10+** — *"They warn before they hit, every time, and the warning is unmistakable — stamp, bellow, lowered rack. Nobody has ever been gored by a glassback without being told first. And if that's a bull in season, it charges in a straight line and cannot turn inside it. Don't meet it. Step off the line and let it go past."*
...
**Adaptation.** The mineral can be anything with value and a sound: glass, amber, salt-crystal, cold iron. Keep two things. First, the shed rack — the fact that the valuable thing is *freely available* to anyone patient is what makes killing for it a choice rather than a necessity. Second, the warning. A glassback that attacks without display is an ordinary large animal, and this book already has enough of those.

---

## Ledgerlice

*The page you have just turned has a hole in it. Not a tear — a hole, clean-edged, exactly the shape of the paragraph that used to be there. As you look, a second one opens in the facing page, and the grey thing making it does not stop for you.*

A ledgerlouse is grey, flat, thumbnail-sized, and built around a jaw that does one job. It eats paper, prefers ink, and takes matter out of a bound volume so precisely that the spine never slackens and the book sits on the shelf looking exactly as it did. An infested archive appears to be in excellent condition right up until somebody opens something, and then it appears to have been robbed.

**They cannot be starved out, only fed elsewhere.** A swarm follows the densest concentration of written matter it can sense, and it does not distinguish between a priceless cartulary and a stack of blank requisition forms with the ink still wet on them. Every competent archivist in the world knows this. Most of them are too proud to admit that the solution to the great threat to human knowledge is a decoy pile of ledgers in the next room.
...
> **What Characters Can Know — ledgerlice**
>
> **6−** — *"Something's eating the collection, and it's doing it neatly."*
>
> **7–9** — *"Ledgerlice. You can't kill a swarm — you scatter it and it's back inside the hour. They go for the densest paper in the room, and they don't care whether it's valuable."*
>
> **10+** — *"So give them something. A stack of blanks with fresh ink, laid down in a room you don't mind losing, pulls the entire swarm inside one exchange. Archives have been doing it for centuries and none of them will say so out loud."*
...
**Adaptation.** Swap the medium: something that eats clay tablets, memory-crystals, knotted cord. Keep the neatness, keep the decoy solution, and keep the fact that the damage is invisible until inspected. The horror of ledgerlice is entirely retrospective.
...
> **6−** — *"It's a chicken."*
>
> **7–9** — *"It's a chicken, and it is not with anyone."*
>
> **10+** — *"It's a chicken."*
...
**Do not give the chicken a name.** If the party names it, that is entirely their fault, and the Mirror Master should remember it forever.
