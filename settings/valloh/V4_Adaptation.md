...
Val'loh is a continent of the same world as Shattered Origin. This is not a conversion between two games or two settings; it is a different part of one place, far enough away that the names have not travelled and the tribes have never heard of a Facet of the Soul by that name.

So a character built for Shattered Origin can walk into Val'loh with nothing changed on their sheet. They will be a foreigner, which is a role Val'loh has a great many words for and no shortage of.
...
**Players:** `V1` for the peoples, then `V2` for how the magic works. That is everything you need to build a character.

**Mirror Masters:** `V3` for the place and its recent wound, and then *Oraga Night*, which is the module this Facet was written to carry.

**Anyone bringing a core-book character in:** this file, and then `V1`.
