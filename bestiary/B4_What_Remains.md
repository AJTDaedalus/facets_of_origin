...
Two entries and a silence.

This chapter is where the book's register does the most work. Everything in it is about death and unfinished business, and none of it is horror — Facets of Origin runs in the adventure register, and the adventure-register version of a haunting is not *you are being punished* but *somebody needed help and nobody came*. The Waiting are sad. The Unfinished is enormous and sad. The hushfall is not sad at all, but it is the only thing in this book that cannot be hit, and that turns out to be its own kind of unsettling.

Run these warm. The party should end these encounters having done something decent, and the fights in this chapter are what happens when that fails.

---

## The Waiting

*Somebody is working at the far end of the room. The hands move properly — you can tell competence from across a room, and this is competence. The tools are where a tradesperson would keep them. It is a good few seconds before you notice that the piece they are working on was finished before any of you were born, and that they are finishing it again.*

The Waiting are people who died in the middle of a job and did not stop.

Not all of them, and not most of them — the great majority of people who die at work simply die at work. What produces a Waiting One is a specific and mercifully rare combination: a task the person considered genuinely unfinished, an interruption sudden enough that they never accepted it had happened, and nobody afterward who completed the work. Take away any of the three and there is no Waiting One. That is why they cluster: a mine collapse, a fire in a workshop quarter, a ship lost with the cargo half-stowed.

**They are not hostile.** This is the thing every entry about the restless dead gets wrong and this one will not. A Waiting One is *occupied*. Violence is an interruption, and it is treated as one — irritably, then decisively, and never first. Stand in the light and it works around you. Pick up a tool and help and it accepts the help, immediately and without comment, because it has been waiting for exactly that for a very long time.

Damage the work and it becomes something else entirely.
...
> **What Characters Can Know — the Waiting**
>
> **6−** — *"They're working. Whatever else is true, that's a person doing a job and doing it well."*
>
> **7–9** — *"They died in the middle of it and haven't accepted that. They won't start anything — but if you break what they're making, they will finish you and go back to work."*
>
> **10+** — *"Help. Just help. Pick up the other end, hold the light, hand them what they're reaching for — the moment you're advancing the job you stop being an obstacle, and when it's actually done they stop. That's the whole of it. Everyone who has ever fought one of these has been the second-cleverest person in the room."*
...
**Adaptation.** The task is the entry, so make it local: a loom, a hull, a ledger, a wall, a meal for a household that is not coming home. Keep the three conditions that make one, keep the fact that they never strike first, and keep the help. A restless dead that attacks on sight is a different creature and a much less interesting one.

---

## The Unfinished

*The work is enormous. That is the first thing — not the figures moving on it, not the sound, but the sheer scale of what is being built or repaired or excavated here, and how much of it there is, and how obviously it has been going on for a very long time. Something at the centre of it turns and looks at you, and then looks past you, and then makes a gesture that is unmistakably* you, there, take the other end.

The Unfinished is what happens when a Waiting One was a foreman.

The conditions are the same — a task considered unfinished, an interruption never accepted, nobody who completed the work — but the task was not one person's job. It was a *project*: a sea wall, a cathedral, a drainage system, a levee, a road through mountains. And the person who did not stop was the person whose job was making other people do it.

**So it recruits.** Every Waiting One at the site is working on the great work, on jobs that were never theirs, under a foreman who has been reorganising the labour for decades. Some of them died on this project. Some of them died three streets away doing something else entirely and were reassigned. The Unfinished does not distinguish, because from where it stands the distinction has never been relevant.
...
> **What Characters Can Know — the Unfinished**
>
> **6−** — *"That's a work site, and it's staffed, and none of the staff are alive."*
>
> **7–9** — *"There's one running it. The rest are doing jobs that were never theirs — it's been reassigning people for as long as there have been people here to reassign."*
>
> **10+** — *"It cannot stop, because the work can't be completed — not with what's here. But it *listens*. Bring it a real plan for finishing, and it will hear you out in the middle of a fight, and if the plan is good it puts the tools down. So does everyone else. That is the ending this place has been waiting a very long time for."*
...
**Adaptation.** Scale the work to your setting's biggest unfinished thing. Keep the recruitment, keep the fact that refusal is free but costly, and keep the impossibility — an Unfinished whose project can simply be completed by hand is a long afternoon, not an entry.
...
**What is known.** Hushfalls drift. They are perhaps twenty to sixty feet across, they move at roughly walking pace, and they do not appear to be steered by anything. Inside one, sound does not travel — not speech, not signals, not the noise a person makes falling over. They pass through walls without effect on the walls.

*Some say* a hushfall is what is left where something enormous was very quiet for a very long time. *Others hold* that they are alive, in the way weather is alive, and that the drifting is feeding. *One account*, which nobody has been able to corroborate and which everybody repeats, has a hushfall stopping — deliberately, over a single house, for eleven days. This book does not resolve the question.

> **What Characters Can Know — hushfall**
>
> **6−** — *"The sound is gone. All of it. That's not a spell anyone here is casting."*
>
> **7–9** — *"A hushfall. It drifts, it's maybe fifty feet across, and it goes through walls. You can't fight it and you can't shout for help inside it — the only thing that works is out."*
>
> **10+** — *"Find the edge and mark it. It moves at a walk, so it can be left, but not by anyone who's lost track of which way they were facing — and inside one, everybody loses track. Rope. Touch. Somebody with a hand on somebody's shoulder, all the way out."*
