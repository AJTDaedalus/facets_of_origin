...
> **Naming note (2026-08-09):** the name "Resonance" proposed above has since been used for a Soul *domain* (sound, vibration, harmonic force — PHB II.3) and must not be reused as a tradition name. The core PHB deliberately names no traditions: it keys them to attributes instead — Spirit governs intuitive magic, Knowledge governs scholarly magic (II.3, *Rolling Magic*), and as of T4.1/D7 each keys a skill as well (Spirit adds Attune, Knowledge adds Lore). **Settled (owner ruling, 2026-08-09, DECISIONS D15):** the setting-layer tradition names are **Invocation** (intuitive — Spirit/Attune, Soul-aligned) and **Thaumaturgy** (scholarly — Knowledge/Lore, Mind-aligned). **There are two, not three.** The "Wild" tradition suggested above is void: the Facet of the Body has no domains, no domain-granting Technique, and no magic-granting Background, and that territory (living things, the natural world) went to Soul as the Verdance, Beasts, and The Living World *domains*. A Body character who wants magic cross-trains into Mind or Soul at the standard cross-Facet cost (II.3, *Acquiring a Domain*) — see DECISIONS D15.
