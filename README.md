...
- **Magic** — Domain + Intent + Scope system with no spell lists. 21 domains across two traditions (Thaumaturgy/Mind, Invocation/Soul); the third tradition (Tempering/Body) is named but its domains are deferred to the Shattered Origin setting Facet. Focused, Standard, Broad, and Prismatic domain types
